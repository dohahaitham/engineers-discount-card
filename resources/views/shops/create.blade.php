    ...
    <div class="w-full max-w-2xl px-4">
        <div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
            ...
            <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                ...
                <a href="{{ url('/admin/dashboard') }}" class="text-sm font-semibold text-gray-500 hover:text-indigo-600 transition">
                    ← رجوع لوحة التحكم
                </a>
            </div>
            ...
            <!-- هنا تعديل المسار ليعمل مباشرة بدون أخطاء الراوت -->
            <form action="{{ url('/admin/shops') }}" method="POST" class="space-y-5">
                @csrf
